# Graph Report - app-zooloo  (2026-07-29)

## Corpus Check
- 159 files · ~318,576 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8422 nodes · 21766 edges · 267 communities (210 shown, 57 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 2272 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `86d8b126`
...
## Communities (267 total, 57 thin omitted)

### Community 0 - "obsidian-excalidraw-plugin/main.js"
Cohesion: 0.01
Nodes (339): addStringToPool(), allwaysPassedUseAttrs, alpha(), anyModifierKeysPressed(), applyArabicRequireLigatures(), applyLatinLigatures(), argument(), attrHandlers (+331 more)

### Community 1 - "dataview/main.js"
Cohesion: 0.01
Nodes (270): RFC-1123, RFC-2616, RFC-2822, A$2(), accurateMatrix, add_css(), add_css$1(), add_css$2() (+262 more)

### Community 2 - "obsidian-kanban/main.js"
Cohesion: 0.01
Nodes (185): $1(), aB(), abutsStart(), aD(), aw(), Ax(), bimap(), block() (+177 more)

### Community 3 - "obsidian-tasks-plugin/main.js"
Cohesion: 0.01
Nodes (134): jO(), jy(), addPreset(), addTimezone(), ag(), allPropertyNames(), allPropertyNamesSorted(), booleanAnd() (+126 more)

### Community 4 - "e"
Cohesion: 0.02
Nodes (86): ActionButton, addSVGToImgSrc(), addYouTubeThumbnail(), applyDefaultSvgTheme(), blobToBase64(), BLOCKED_SVG_TAGS, cloneKnownAIProviderProfiles(), cloneModelConfigs() (+78 more)

### Community 5 - "DateTime"
Cohesion: 0.02
Nodes (51): adjustTime(), bestBy(), buildRegex(), DateTime, digitRegex(), escapeToken(), expandMacroTokens(), explainFromTokens() (+43 more)

### Community 6 - "ExcalidrawView"
Cohesion: 0.02
Nodes (22): calculateUIModeValue(), deleteAppStateKeys(), ExcalidrawView, exportImageToFile(), getBoundTextElementId(), getElementsAtPointer(), getElementWithLinkAtPointer(), getExcalidrawViews() (+14 more)

### Community 7 - "Locale"
Cohesion: 0.03
Nodes (33): dateTimeFromMatches(), eraForDateTime(), extractIANAZone(), extractISODuration(), extractISOTime(), getCachedDTF(), getCachedLF(), getCachedRTF() (+25 more)

### Community 8 - ".push"
Cohesion: 0.02
Nodes (152): ABS(), absolutize(), ADD(), addSegment(), addTerminatorSegment(), ALIGNRP(), AND(), arcToCubicCurves() (+144 more)

### Community 9 - "ExcalidrawAutomate"
Cohesion: 0.02
Nodes (29): createPNG(), createSliderWithText(), download(), editorInsertText(), ensureActiveScriptSettingsObject(), errorMessage(), ExcalidrawAutomate, exportPNG() (+21 more)
...
Cohesion: 0.03
Nodes (110): _0(), after(), aP(), aS(), b0(), B1(), ba(), bc() (+102 more)

### Community 12 - "n"
Cohesion: 0.06
Nodes (137): p(), aa(), aN(), aO(), B(), be(), bO(), Br() (+129 more)

### Community 13 - "Duration"
Cohesion: 0.03
Nodes (27): asNumber(), clone$1(), dayDiff(), diff(), diffRelative(), Duration, durationToMillis(), formatRelativeTime() (+19 more)

### Community 14 - "t$d"
Cohesion: 0.03
Nodes (27): AIModelConfigModal, AIProviderProfileModal, AIUsageModal, checkExcalidrawVersion(), checkVersionMismatch(), displayFontMessage(), EmbeddableSettings, ExportDialog (+19 more)
...
### Community 17 - "l"
Cohesion: 0.05
Nodes (96): T(), AD(), addClassName(), addDataAttribute(), addInternalClasses(), Ae(), apply(), applyEdits() (+88 more)

### Community 18 - "ExcalidrawPlugin"
Cohesion: 0.04
Nodes (11): copyLinkToSelectedElementToClipboard(), emulateCTRLClickForLinks(), EXCALIDRAW_EXTERNAL_GET_LABEL_KEY_SET, ExcalidrawPlugin, foldExcalidrawSection(), hoverEvent(), initializeMarkdownPostProcessor(), ObserverManager (+3 more)

### Community 19 - ".slice"
Cohesion: 0.07
Nodes (38): _3(), aI(), bf(), bi(), cO(), day(), Df(), Dg() (+30 more)

### Community 20 - ".then"
Cohesion: 0.08
Nodes (70): _advanceReadiness(), all(), _binStringToArrayBuffer(), bufferToString(), callWhenReady(), _checkBlobSupport(), _checkBlobSupportWithoutCaching(), clear() (+62 more)

### Community 21 - "handleImageRequest"
Cohesion: 0.04
Nodes (88): AI_BASE_URL_SUFFIXES, analyzeAIImage(), applyOutgoingTokenBudget(), buildGenerateAIImageResult(), buildMultipartFormBody(), buildNormalizedMessages(), cloneAIRequestMessage(), cloneAIRequestMessageContent() (+80 more)

### Community 22 - "t"
Cohesion: 0.04
Nodes (68): $2(), a2(), activatePlaceholder(), ag(), Av(), bindScrollHandlers(), cleanUp(), close() (+60 more)

### Community 23 - "templater-obsidian/main.js"
Cohesion: 0.05
Nodes (59): add_user_script_functions_setting(), additional_functions(), br(), ce(), Co(), constructor(), create_dynamic_templates(), createForm() (+51 more)

### Community 24 - "DataviewApi"
Cohesion: 0.05
Nodes (27): Context, DataviewApi, DataviewCalendarRenderer, defaultLinkHandler(), enumerateChildren(), executeCalendar(), executeInline(), executeList() (+19 more)

### Community 25 - "ExcalidrawData"
Cohesion: 0.06
Nodes (13): arrayToMap$1(), changeThemeOfExcalidrawMD(), compress(), compressAsync(), EMBEDDABLE_THEME_FRONTMATTER_VALUES, ExcalidrawData, getMarkdownDrawingSection(), getMarkdownDrawingSectionAsync() (+5 more)

### Community 26 - "createBinaryOps"
Cohesion: 0.06
Nodes (10): addFields(), BinaryOpHandler, buildInlineFields(), createBinaryOps(), CsvCache, FileImporter, FullIndex, ListItem$1 (+2 more)

### Community 27 - "yM"
Cohesion: 0.36
Nodes (8): hour(), millisecond(), minute(), qL(), second(), wM(), yM(), Yy()

### Community 28 - "kn"
Cohesion: 0.03
Nodes (129): aC(), addView(), archiveCompletedCards(), au(), bg(), bh(), bk(), Ca() (+121 more)

### Community 29 - ".push"
Cohesion: 0.04
Nodes (76): $2(), AA(), aU(), BS(), buildExplanation(), c0(), ce(), CM() (+68 more)

### Community 30 - "get"
Cohesion: 0.09
Nodes (52): _0(), assign(), b0(), cancelledDate(), checkAndReturnWithFollowingPattern(), checkAndReturnWithoutFollowingPattern(), clone(), createdDate() (+44 more)
...
### Community 34 - "a"
Cohesion: 0.04
Nodes (112): a(), add(), ae(), Am(), At(), bb(), bM(), Bt() (+104 more)

### Community 35 - "getBoundingClientRect"
Cohesion: 0.06
Nodes (62): arrow(), clamp(), computeAutoPlacement(), computeOffsets(), computeStyles(), detectOverflow(), distanceAndSkiddingToXY(), effect() (+54 more)

### Community 36 - "f"
Cohesion: 0.12
Nodes (58): At(), B(), be(), bi(), bn(), Bt(), di(), Dr() (+50 more)

### Community 37 - "debug"
Cohesion: 0.06
Nodes (55): AC(), allDateFields(), applySearchBoxFilterAndRerender(), configure(), debug(), deprecate(), dL(), executeParser() (+47 more)

### Community 38 - "ToolsPanel"
Cohesion: 0.07
Nodes (13): getYouTubeUrl(), internalDragModifierType(), isSHIFT(), isWinALTorMacOPT(), isWinCTRLorMacCMD(), isWinMETAorMacCTRL(), localFileDragModifierType(), openExternalLink() (+5 more)
...
### Community 40 - "ni"
Cohesion: 0.07
Nodes (35): a0(), al(), BD(), bl(), fileName(), gL(), HL(), hw() (+27 more)

### Community 41 - ".forEach"
Cohesion: 0.04
Nodes (78): addFiles(), addFilterToForeignObjects(), applyReviver(), checkScriptUpdates(), cloneElement(), convertSVGStringToElement(), createFileAndAwaitMetacacheUpdate(), createImageDiv() (+70 more)

### Community 42 - "Kn"
Cohesion: 0.05
Nodes (60): Al(), aq(), BD(), bE(), by(), compareTaskSortKeys(), compareTaskSortKeysIfEitherIsNull(), compareTaskSortKeysIfOptionalMoment() (+52 more)

### Community 43 - "contains"
Cohesion: 0.05
Nodes (24): arrayToMap(), CANVAS_VIEWTYPES, CanvasNodeFactory, contains(), ContentSearcher, CustomEmbeddable(), escapeRegExp(), ExcalidrawLoading (+16 more)

### Community 44 - "add"
Cohesion: 0.06
Nodes (56): add(), addAllTaskGroups(), addBacklinks(), addChildren(), addCopyButton(), addDefaultStatusTypes(), addEditButton(), addEmptyLine() (+48 more)
...
### Community 47 - "t"
Cohesion: 0.04
Nodes (87): n$a, acquire(), addTooltip(), bc(), bU(), buildFilterFunction(), buildGroupingTree(), calculate() (+79 more)
...
### Community 49 - "y$1"
Cohesion: 0.06
Nodes (40): asyncTryOrPropagate(), B$2(), createFixedListView(), createFixedTableView(), createFixedTaskView(), createListView(), createTableView(), createTaskView() (+32 more)
...
### Community 53 - ".includes"
Cohesion: 0.08
Nodes (16): extractInlineFields(), extractSpecialTaskFields(), extractSubtags(), findClosing(), findSeparator(), findSpecificInlineField(), FunctionBuilder, getExtension() (+8 more)

### Community 54 - "resolve"
Cohesion: 0.07
Nodes (49): addNamespaces(), _addQueryRenderChild(), addResource(), addResourceBundle(), addResources(), changeLanguage(), cloneInstance(), dir() (+41 more)

### Community 55 - "parseBuffer"
Cohesion: 0.17
...
### Community 58 - ".onload"
Cohesion: 0.05
Nodes (20): asyncEvalInContext(), canonicalizeVarName(), DataviewInlineJSRenderer, DataviewInlineRenderer, DataviewJSRenderer, DataviewPlugin, DataviewRefreshableRenderer, evalInContext() (+12 more)
...
Cohesion: 0.09
Nodes (10): cleanBlockRef(), cleanSectionHeading(), EmbeddableMenu, EmbeddedFile, getEmbeddedFilenameParts$1(), getLinkParts$1(), getTransclusion(), isHeadingBlockEntry() (+2 more)
...
Cohesion: 0.05
Nodes (49): addEdgeIfNotToInternal(), addStatus(), bulkAddStatusCollection(), bx(), bySymbol(), bySymbolOrCreate(), copyStatusWithNewName(), createFromImportedValue() (+41 more)

### Community 64 - "apiClient.ts"
Cohesion: 0.10
Nodes (24): PreviewScreen(), PuleTermicaProps, apiCall(), ApiEnvelope, ApiError, base64UrlDecode(), CallOptions, decodeJwt() (+16 more)

### Community 65 - "FloatingModal"
Cohesion: 0.06
Nodes (13): AUDIO_TYPES, CODE_TYPES, CropImage, FileSuggestionModal, FloatingModal, getSortedLinkMatches(), InsertMDDialog, isImageOrPDFTransclusion() (+5 more)

### Community 66 - "toString"
Cohesion: 0.10
Nodes (20): addOneSettingsBlock(), append(), areTagsShown(), asMarkdown(), debouncedRender(), gl(), makeQueryFromSourceAndTasksFile(), nf() (+12 more)

### Community 67 - "matchingSourcePaths"
Cohesion: 0.08
Nodes (7): IndexMap, LocalStorageCache, matchingSourcePaths(), outro_and_destroy_block(), PrefixIndex, transition_out(), ValueCaseInsensitiveIndexMap

### Community 69 - "a1"
Cohesion: 0.06
Nodes (36): a1(), adjustRelativeLinksInDescription(), deserialize(), equals(), extractDateField(), extractField(), extractHashtags(), extractTaskComponents() (+28 more)
...
### Community 79 - "create_static_templates"
Cohesion: 0.07
Nodes (35): getValue(), pi(), create_static_templates(), De(), dn(), e(), generate_clipboard(), generate_creation_date() (+27 more)

### Community 80 - "GenericInputPrompt"
Cohesion: 0.11
Nodes (3): GenericInputPrompt, PublishOutOfDateFilesDialog, select()
...
### Community 82 - "wrapValue"
Cohesion: 0.09
Nodes (20): _classCallCheck(), compareValue(), DataviewIOApi, executeTwoCallbacks(), extend(), _fullyReady(), isBoolean(), isDate() (+12 more)
...
### Community 85 - "Fe"
Cohesion: 0.14
Nodes (22): rF(), Bo(), ci(), closing_tag(), cr(), Fe(), Fi(), Fo() (+14 more)
...
### Community 87 - "dW"
Cohesion: 0.11
Nodes (23): addRow(), addRowIfNew(), allStatuses(), applyToStatusRegistry(), Cg(), cW(), cx(), dW() (+15 more)

### Community 88 - "expo-router"
Cohesion: 0.12
Nodes (16): plugins, PUBLIC_ROUTES, RootLayoutNav(), LoginScreen(), styles, HomeScreen(), styles, Props (+8 more)
...
Cohesion: 0.10
Nodes (21): eslint, eslint-config-expo, jest, jest-expo, devDependencies, eslint, eslint-config-expo, jest (+13 more)

### Community 93 - "Test-Driven Development (TDD)"
Cohesion: 0.06
...
Cohesion: 0.11
Nodes (17): node_modules/, userIgnoreFilters, android/, build/, coverage/, dist/, .expo, .expo-shared (+9 more)
...
### Community 98 - "t"
Cohesion: 0.03
Nodes (88): a(), applyArabicPresentationForms(), applyStyles(), BuildLog$1(), c$2(), c$4(), c$5(), chainingSubstitutionFormat3$1() (+80 more)

### Community 100 - "Ds"
Cohesion: 0.09
Nodes (31): applySettingsUpdate(), AR(), Bx(), calculateDragIntersect(), Cg(), Ck(), CR(), dragEnd() (+23 more)
...
Cohesion: 0.06
Nodes (29): 1. Mapa de Modalidades, 2. Fluxo de Processamento, 3. Regras de Validação por Modalidade, 4. Regras de Negócio Transversais, Detalhamento das Etapas:, Horários de Corte / Fechamento de Sorteio, Limites de Valor, Lógica de Cálculo de Prêmio e Rateio (+21 more)
...
### Community 118 - "Autenticação — App Zooloo"
Cohesion: 0.07
...
Cohesion: 0.12
Nodes (7): extractISOOffset(), FixedOffsetZone, formatOffset(), isString(), normalizeZone(), offset(), signedOffset()
...
### Community 123 - ".fromObject"
Cohesion: 0.14
Nodes (19): computeOrdinal(), dayOfWeek(), daysInYear(), gregorianToOrdinal(), gregorianToWeek(), hasInvalidGregorianData(), hasInvalidOrdinalData(), hasInvalidTimeData() (+11 more)
...
### Community 128 - "EventManager"
Cohesion: 0.10
Nodes (6): EventManager, getAllWindowDocuments(), getParentOfClass(), patchMobileView(), setStyleText(), StylesManager

### Community 130 - "CarrinhoContext.tsx"
Cohesion: 0.47
Nodes (4): CarrinhoContext, CarrinhoContextData, CarrinhoProvider(), ApostaItem
...
### Community 133 - "i"
Cohesion: 0.04
Nodes (103): a$3(), a$7(), a$9(), analyze(), areValidElements(), around(), around1(), attachOutsideHandlers() (+95 more)

### Community 134 - "Plano Técnico de Desenvolvimento — App Zooloo"
Cohesion: 0.10
Nodes (21): 0. Como ler este documento, 10. Segurança e compliance, 11.1 Criação e confirmação de aposta, 11.2 Expiração / refresh, 11. Fluxos principais, 13. Riscos técnicos e mitigação, 14. Perguntas para o cliente/equipe, 1. Resumo executivo (+13 more)

### Community 139 - "Visual Companion Guide"
Cohesion: 0.10
...
Cohesion: 0.10
Nodes (20): 10. Hierarquia de Limites (precedência), 11. Resumo de Chaves para o App Mobile, 1. Catálogos Internos (`int_`), 5. Auditoria (`data_`), 6. Autenticação Mobile (`mob_`), 7. Views, 8. Triggers e Funções, 9. Campo `palpites` — Formato da String Posicional (+12 more)

### Community 151 - "Fluxo passo a passo"
Cohesion: 0.11
...
Cohesion: 0.15
Nodes (19): cc(), create(), cS(), extract(), formatToParts(), isEnglish(), l2(), listingMode() (+11 more)
...
### Community 158 - "Testing CLAUDE.md Skills Documentation"
Cohesion: 0.12
...
### Community 162 - "Root Cause Tracing"
Cohesion: 0.12
Nodes (15): 1. Observe the Symptom, 2. Find Immediate Cause, 3. Ask: What Called This?, 4. Keep Tracing Up, 5. Find Original Trigger, Adding Stack Traces, Finding Which Test Causes Pollution, Key Principle (+7 more)

### Community 163 - "Systematic Debugging"
Cohesion: 0.12
...
### Community 166 - "Using Git Worktrees"
Cohesion: 0.13
...
### Community 168 - "Fase 2 — Tela de aposta do Jogo do Bicho"
Cohesion: 0.13
Nodes (14): Comprovante, Critérios de aceite, Dependências, Fase 2 — Tela de aposta do Jogo do Bicho, Integração com backend, Log de progresso, Notas técnicas, Objetivo (+6 more)

### Community 169 - "Dispatching Parallel Agents"
Cohesion: 0.14
...
### Community 172 - "4. Movimentação Transacional (`mov_`)"
Cohesion: 0.15
Nodes (13): 4. Movimentação Transacional (`mov_`), Estrutura de Bilhetes — Bilhetinho/Quininha/Seninha, Estrutura de Bilhetes — Jogo do Bicho (JB), `mov_bilhetinho` — Bilhete Bilhetinho/Quininha/Seninha, `mov_bilhetinho_sort_palpite` — Palpites individuais (5 colocações), `mov_bilhetinho_sorteio` — Detalhes por Sorteio, `mov_caixa` — Caixa Diário do Vendedor, `mov_caixa_lancamentos` — Lançamentos do Caixa (+5 more)

### Community 173 - "Defense-in-Depth Validation"
Cohesion: 0.17
...
### Community 176 - "3. Configurações de Negócio (`cfg_`)"
Cohesion: 0.17
...
### Community 177 - "Ph"
Cohesion: 0.21
Nodes (12): Ah(), Ew(), fO(), gI(), hO(), Lh(), Ph(), Ub() (+4 more)
...
### Community 179 - "cm"
Cohesion: 0.24
Nodes (11): cm(), isAfter(), isBefore(), M0(), mM(), TM(), Tn(), toISO() (+3 more)

### Community 180 - "Executing Plans"
Cohesion: 0.20
...
### Community 181 - "Condition-Based Waiting"
Cohesion: 0.20
...
### Community 182 - "Verification Before Completion"
Cohesion: 0.20
...
### Community 186 - "2. Cadastros Mestres (`cad_`)"
Cohesion: 0.20
...
### Community 189 - "parseGlyfTableAll"
Cohesion: 0.29
Nodes (10): buildPath(), defineDependentProperty(), glyphLoader(), parseGlyfTable(), parseGlyfTableAll(), parseGlyfTableOnLowMemory(), parseGlyph(), parseGlyphCoordinate() (+2 more)

### Community 191 - ".getExcalidrawSVG"
Cohesion: 0.22
...
Cohesion: 0.20
Nodes (9): 1. 🌐 [Graphify](https://github.com/Graphify-Labs/graphify), 2. ⚡ [Superpowers](https://github.com/obra/superpowers), Estrutura de arquivos para o obsidian, 🤖 Ferramentas de IA e Metodologia (AI Agent Tooling), Get a fresh project, Get started, Join the community, Learn more (+1 more)
...
### Community 194 - "Skill authoring best practices"
Cohesion: 0.22
...
### Community 195 - "render-graphs.js"
Cohesion: 0.33
...
Cohesion: 0.22
Nodes (8): `app.json → extra` deve ficar vazio em desenvolvimento, Armadilhas encontradas, Fase 1 — Autenticação Completa, `hooks/use-auth.ts` foi removido, O que foi entregue, Objetivo, Referências, Resultado

### Community 199 - "Brainstorming Ideas Into Designs"
Cohesion: 0.25
...
### Community 201 - "12. Roadmap por fases"
Cohesion: 0.25
Nodes (8): 12. Roadmap por fases, Fase 0 — Descoberta de regras (BLOQUEANTE) `[NOVA]`, Fase 1 — Backend REST, Fase 2 — Mobile base, Fase 3 — Design system e temas `[pode correr em paralelo à Fase 2]`, Fase 4 — Módulo de apostas, Fase 5 — Impressão (Bluetooth + POS), Fase 6 — Segurança, QA, publicação

### Community 202 - "stop-server.sh"
Cohesion: 0.43
Nodes (4): command_has_server_id(), is_brainstorm_server(), mark_stopped(), stop-server.sh script

### Community 203 - "codex-tools.md"
Cohesion: 0.29
Nodes (3): Codex App Finishing, Environment Detection, Subagent dispatch requires multi-agent support

### Community 204 - "Gemini CLI Tool Mapping"
Cohesion: 0.29
...
Cohesion: 0.29
Nodes (7): 5.1 Estrutura de pastas proposta (incremental), 5.2 Navegação, 5.3 Estado, 5.4 Camada de API e autenticação, 5.5 Offline, fila e antiduplicação, 5.6 Design system, tema claro e dark, 5. Arquitetura mobile

### Community 208 - "Múltiplos Intervalos e Valores na Tela de Prêmios"
Cohesion: 0.29
Nodes (6): Contexto e Motivação, Critérios de Aceite, Escopo, Múltiplos Intervalos e Valores na Tela de Prêmios, Referências, Subtarefas

### Community 209 - "BUG-00X: [Título do Bug]"
Cohesion: 0.29
Nodes (6): Arquivos Afetados, BUG-00X: [Título do Bug], Como Reproduzir, Descrição do Problema, Resolução (Preencher ao resolver), Sintomas

### Community 210 - "Regras do Projeto Zooloo (Workspace Rules)"
Cohesion: 0.33
Nodes (5): 🔌 Comunicação com o Backend, 📁 Estrutura de Documentação do Projeto (Segundo Cérebro), ⚖️ Regra de Ouro (Inegociável), Regras do Projeto Zooloo (Workspace Rules), 🏗️ Stack de Desenvolvimento e Padrões de Código

### Community 211 - "using-superpowers/SKILL.md"
Cohesion: 0.33
Nodes (5): Platform Adaptation, Red Flags, Skill Priority, The Rule, User Instructions

### Community 212 - "Skill Discovery Optimization (SDO)"
Cohesion: 0.33
...
### Community 213 - "Bulletproofing Skills Against Rationalization"
Cohesion: 0.33
...
### Community 214 - "Regras de Negócio e Jogos do Zooloo"
Cohesion: 0.33
Nodes (5): 🔒 Comunicação Transacional com o Banco, Contexto de Negócio, 🖨️ Formato do Comprovante (Largura Térmica), Regras de Negócio e Jogos do Zooloo, 🛠️ Validação de Palpites no App

### Community 215 - "BUG-001: Data de Sorteio Hardcoded em `ApostaService.listarExtracoes`"
Cohesion: 0.33
Nodes (5): Arquivos Afetados, BUG-001: Data de Sorteio Hardcoded em `ApostaService.listarExtracoes`, Descrição do Problema, Resolução, Sintomas

### Community 216 - "3. Análise das modalidades de jogo"
Cohesion: 0.33
Nodes (6): 3.1 Mapa dos quatro jogos `[CONFIRMADO NO SQL — int_jogo + filtro_banca]`, 3.2 Jogo do Bicho — modalidades `[CONFIRMADO NO SQL]`, 3.3 Quininha (jogo 25) / Seninha (jogo 27) `[CONFIRMADO NO SQL]`, 3.4 Lotinha (jogo 37) `[CONFIRMADO NO SQL]`, 3.5 Exemplo de payload de criação de aposta (proposto), 3. Análise das modalidades de jogo

### Community 217 - "9. Impressão — Bluetooth térmico **e** maquineta POS"
Cohesion: 0.33
Nodes (6): 9.1 Dois caminhos de hardware, 9.2 Limitações do Expo, 9.3 ESC/POS e layout, 9.4 Pareamento, reconexão e falhas, 9.5 Conteúdo mínimo do comprovante (pule), 9. Impressão — Bluetooth térmico **e** maquineta POS

### Community 218 - "[Título da Tarefa]"
Cohesion: 0.33
Nodes (5): Critérios de Aceite, Escopo, Referências, Subtarefas, [Título da Tarefa]

### Community 219 - "Pressure Test 1: Emergency Production Fix"
Cohesion: 0.40
Nodes (4): Choose A, B, or C, Pressure Test 1: Emergency Production Fix, Scenario, Your Options

### Community 220 - "Pressure Test 2: Sunk Cost + Exhaustion"
Cohesion: 0.40
Nodes (4): Choose A, B, or C, Pressure Test 2: Sunk Cost + Exhaustion, Scenario, Your Options

### Community 221 - "Pressure Test 3: Authority + Social Pressure"
Cohesion: 0.40
Nodes (4): Choose A, B, or C, Pressure Test 3: Authority + Social Pressure, Scenario, Your Options

### Community 222 - "anthropic-best-practices.md"
Cohesion: 0.40
...
### Community 224 - "Testing All Skill Types"
Cohesion: 0.40
...
### Community 225 - "RED-GREEN-REFACTOR for Skills"
Cohesion: 0.40
...
### Community 226 - "VERIFY GREEN: Pressure Testing"
Cohesion: 0.40
...
### Community 227 - "Fluxo de Autenticação, Offline e Permissões do Zooloo"
Cohesion: 0.40
...
### Community 238 - "Setup inicial do Obsidian para o projeto Zooloo"
Cohesion: 0.50
...
## Knowledge Gaps
- **1182 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+1177 more)
...
- **Why does `p()` connect `n` to `dataview/main.js`, `obsidian-kanban/main.js`, `i`, `fromObject`, `e`, `l`, `.slice`, `t`, `templater-obsidian/main.js`, `DataviewApi`, `kn`, `a`, `constructor`, `y$1`, `resolve`, `.onload`, `display`, `toString`, `Fe`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `SegmentChainer$1()` connect `i` to `obsidian-excalidraw-plugin/main.js`, `.push`, `ExcalidrawAutomate`, `ExcalidrawSidepanelView`, `.forEach`, `n`, `l`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `n$a` connect `t` to `obsidian-excalidraw-plugin/main.js`, `get`?**
