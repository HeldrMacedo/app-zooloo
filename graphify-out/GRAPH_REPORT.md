...
## Corpus Check
- 159 files · ~318,664 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8423 nodes · 21771 edges · 262 communities (206 shown, 56 thin omitted)
...
## Communities (262 total, 56 thin omitted)

### Community 0 - "obsidian-excalidraw-plugin/main.js"
Cohesion: 0.01
Nodes (308): a$7(), addStringToPool(), allwaysPassedUseAttrs, anyModifierKeysPressed(), applyArabicRequireLigatures(), applyLatinLigatures(), attrHandlers, bezier() (+300 more)

### Community 1 - "dataview/main.js"
Cohesion: 0.01
Nodes (287): RFC-1123, RFC-2616, RFC-2822, accurateMatrix, add_css(), add_css$1(), add_css$2(), add_css$3() (+279 more)
...
Cohesion: 0.01
Nodes (126): jO(), jy(), $2(), AA(), addPreset(), ag(), allPropertyNames(), allPropertyNamesSorted() (+118 more)

### Community 4 - "e"
Cohesion: 0.02
Nodes (87): ActionButton, addSVGToImgSrc(), around(), blobToBase64(), constructor(), containsNewline(), customAlphabet(), customRandom() (+79 more)

### Community 5 - "DateTime"
Cohesion: 0.02
Nodes (60): adjustTime(), asNumber(), bestBy(), clone$1(), computeOrdinal(), DateTime, dateTimeFromMatches(), dayDiff() (+52 more)

### Community 6 - "ExcalidrawView"
Cohesion: 0.03
Nodes (24): arrayToMap(), calculateUIModeValue(), errorlog(), ExcalidrawView, extractDiagramHTML(), getBoundTextElementId(), _getContainerElement(), getElementsAtPointer() (+16 more)

### Community 7 - "Locale"
Cohesion: 0.02
Nodes (47): buildRegex(), digitRegex(), eraForDateTime(), escapeToken(), expandMacroTokens(), explainFromTokens(), FixedOffsetZone, formatOffset() (+39 more)

### Community 8 - ".push"
Cohesion: 0.02
Nodes (151): ABS(), absolutize(), ADD(), addSegment(), addTerminatorSegment(), analyze(), AND(), arcToCubicCurves() (+143 more)

### Community 9 - "ExcalidrawAutomate"
Cohesion: 0.02
Nodes (36): ALIGNRP(), COLOR_NAMES, createOrOverwriteFile(), cropCanvas(), download(), ensureActiveScriptSettingsObject(), errorMessage(), ExcalidrawAutomate (+28 more)

### Community 10 - "isScalar"
Cohesion: 0.03
Nodes (68): addCommentBefore(), addMergeToJSMap(), addPairToJSMap(), ALIAS, anchorNames(), asItemIndex(), callVisitor(), clone() (+60 more)
...
### Community 14 - "t$d"
Cohesion: 0.03
Nodes (29): AIModelConfigModal, AIProviderProfileModal, AIUsageModal, displayFontMessage(), EmbeddalbeMDFileCustomDataSettingsComponent, ExcalidrawSettingTab, ExportDialog, fragWithHTML() (+21 more)

### Community 15 - ".registerCommands"
Cohesion: 0.07
Nodes (36): addBackOfTheNoteCard(), addFiles(), addTextWithOEmbed(), ANIMATED_IMAGE_TYPES, captureScreenshot(), carveOutImage(), carveOutPDF(), cloneElement$1() (+28 more)
...
### Community 17 - "l"
Cohesion: 0.04
Nodes (114): T(), AD(), addClassName(), addDataAttribute(), addInternalClasses(), Ae(), apply(), applyEdits() (+106 more)

### Community 18 - "ExcalidrawPlugin"
Cohesion: 0.03
Nodes (16): copyLinkToSelectedElementToClipboard(), dedupe(), emulateCTRLClickForLinks(), EXCALIDRAW_EXTERNAL_GET_LABEL_KEY_SET, ExcalidrawPlugin, executeCommandLinkWithConfirmation(), fileShouldDefaultAsExcalidraw(), foldExcalidrawSection() (+8 more)
...
### Community 20 - ".then"
Cohesion: 0.08
Nodes (71): _advanceReadiness(), all(), _binStringToArrayBuffer(), callWhenReady(), _checkBlobSupport(), _checkBlobSupportWithoutCaching(), checkIfLocalStorageThrows(), _classCallCheck() (+63 more)

### Community 21 - "handleImageRequest"
Cohesion: 0.04
Nodes (90): AI_BASE_URL_SUFFIXES, analyzeAIImage(), applyOutgoingTokenBudget(), buildGenerateAIImageResult(), buildMultipartFormBody(), buildNormalizedMessages(), cloneAIRequestMessage(), cloneAIRequestMessageContent() (+82 more)
...
Cohesion: 0.05
Nodes (27): bufferToString(), Context, DataviewApi, DataviewCalendarRenderer, defaultLinkHandler(), executeCalendar(), executeInline(), executeList() (+19 more)

### Community 25 - "ExcalidrawData"
Cohesion: 0.05
Nodes (19): arrayToMap$1(), compressAsync(), EMBEDDABLE_THEME_FRONTMATTER_VALUES, EmbeddedFile, ExcalidrawData, format(), getEmbeddedFilenameParts$1(), getEmbedFilename() (+11 more)

### Community 26 - ".onload"
Cohesion: 0.05
Nodes (14): addFields(), BinaryOpHandler, createBinaryOps(), DataviewPlugin, FileImporter, FullIndex, inlinePlugin(), isDataviewDisabled() (+6 more)

### Community 27 - ".getScene"
Cohesion: 0.05
Nodes (45): addFilterToForeignObjects(), convertSVGStringToElement(), createFileAndAwaitMetacacheUpdate(), createImageDiv(), createImgElement(), createSVG(), CropImage, exportImageToFile() (+37 more)
...
### Community 29 - ".push"
Cohesion: 0.04
Nodes (72): addEdgeIfNotToInternal(), BS(), bySymbol(), bySymbolOrCreate(), c0(), ce(), constructExplanation(), copyStatusWithNewName() (+64 more)
...
Cohesion: 0.03
Nodes (41): activeFile, attr(), binding_callbacks, binding_callbacks$1, classList(), configureGlobalMomentLocale(), ConfirmationModal, customTagsSource (+33 more)
...
Cohesion: 0.06
Nodes (65): arrow(), clamp(), computeAutoPlacement(), computeOffsets(), computeStyles(), detectOverflow(), distanceAndSkiddingToXY(), effect() (+57 more)
...
Cohesion: 0.07
Nodes (13): checkVersionMismatch(), getYouTubeUrl(), internalDragModifierType(), isSHIFT(), isWinALTorMacOPT(), isWinCTRLorMacCMD(), localFileDragModifierType(), openExternalLink() (+5 more)

### Community 39 - "constructor"
Cohesion: 0.04
Nodes (64): $1(), addItemForInstruction(), addItemsForInstructions(), addTaskGroup(), addTaskGroups(), addTitleRow(), B1(), buildRelative() (+56 more)
...
Cohesion: 0.03
Nodes (43): anchorIsValid(), applyReviver(), assertCollection(), checkExcalidrawVersion(), checkScriptUpdates(), Collection, collectionFromPath(), ContentSearcher (+35 more)

### Community 42 - "Kn"
Cohesion: 0.07
Nodes (47): Al(), aq(), BD(), by(), compareTaskSortKeys(), compareTaskSortKeysIfEitherIsNull(), compareTaskSortKeysIfOptionalMoment(), connectedCallback() (+39 more)

### Community 43 - "contains"
Cohesion: 0.04
Nodes (31): CANVAS_VIEWTYPES, CanvasNodeFactory, contains(), createLeaf(), CustomEmbeddable(), emulateKeysForLinkClick(), EventManager, ExcalidrawLoading (+23 more)
...
### Community 49 - "y$1"
Cohesion: 0.05
Nodes (41): asyncTryOrPropagate(), B$2(), createFixedListView(), createFixedTableView(), createFixedTaskView(), createListView(), createTableView(), createTaskView() (+33 more)

### Community 50 - "screen.tsx"
Cohesion: 0.11
Nodes (22): styles, MODALIDADES, styles, IntervaloAdicionado, NUMEROS_PREMIO, styles, styles, styles (+14 more)

### Community 51 - "h$4"
Cohesion: 0.18
Nodes (11): alpha(), blend_f(), chroma(), css(), cubehelix(), h$4(), hexWithAlpha(), hue() (+3 more)
...
Cohesion: 0.09
Nodes (12): extractSubtags(), findClosing(), findSeparator(), findSpecificInlineField(), FunctionBuilder, getCachedDTF(), getExtension(), intlConfigString() (+4 more)
...
Cohesion: 0.05
Nodes (31): asyncEvalInContext(), buildInlineFields(), canonicalizeVarName(), CsvCache, DataviewInlineJSRenderer, DataviewInlineRenderer, DataviewJSRenderer, DataviewRefreshableRenderer (+23 more)
...
### Community 60 - "getTemplate"
Cohesion: 0.07
Nodes (20): cleanBlockRef(), cleanSectionHeading(), cloneElement(), EmbeddableMenu, getElementsWithLinkMatchingQuery(), getExcalidrawMarkdownHeader(), getExcalidrawMarkdownHeaderSection(), getFrameBasedOnFrameNameOrId() (+12 more)
...
Cohesion: 0.07
Nodes (35): addStatus(), bulkAddStatusCollection(), bx(), createFromImportedValue(), deleteAllCustomStatuses(), deleteStatus(), display(), findStatusIndex() (+27 more)
...
Cohesion: 0.05
Nodes (40): a1(), addOneSettingsBlock(), allDateFields(), append(), areTagsShown(), asMarkdown(), debouncedRender(), findKeyInFrontmatter() (+32 more)
...
### Community 69 - "dW"
Cohesion: 0.05
Nodes (48): addRow(), addRowIfNew(), adjustRelativeLinksInDescription(), allStatuses(), applyToStatusRegistry(), Cg(), cW(), cx() (+40 more)
...
### Community 75 - "Lexer"
Cohesion: 0.24
Nodes (5): editorInsertText(), isEmpty(), isNotAnchorChar(), Lexer, peek()
...
Cohesion: 0.08
Nodes (16): CalendarView, clamp(), createConfirmationDialog(), createDailyNotesStore(), createSelectedFileStore(), createWeeklyNotesStore(), get_store_value(), getDateUIDFromFile() (+8 more)
...
Cohesion: 0.12
Nodes (17): compareValue(), DataviewIOApi, isBoolean(), isDate(), isDuration(), isFunction(), isHtml(), isLink() (+9 more)
...
### Community 86 - "init$1"
Cohesion: 0.10
Nodes (24): add_render_callback$1(), bind(), blank_object$1(), Calendar, children$1(), component_subscribe(), create_fragment(), detach$1() (+16 more)
...
Cohesion: 0.19
Nodes (11): PUBLIC_ROUTES, RootLayoutNav(), LoginScreen(), styles, HomeScreen(), AuthContext, AuthContextType, AuthProvider() (+3 more)

### Community 89 - "init"
Cohesion: 0.11
Nodes (21): add_render_callback(), appHasPeriodicNotesPluginLoaded(), blank_object(), CalendarPlugin, check_outros(), children(), detach(), flush() (+13 more)
...
### Community 94 - "append"
Cohesion: 0.13
Nodes (18): add_css(), add_css$1(), add_css$2(), add_css$3(), add_css$4(), add_css$5(), append(), Arrow (+10 more)
...
Cohesion: 0.14
Nodes (15): create_catch_block(), create_else_block(), create_fragment$5(), create_if_block$1(), create_pending_block(), create_slot(), create_then_block(), get_default_slot_context() (+7 more)

### Community 98 - "nextAfter"
Cohesion: 0.20
...
### Community 114 - "not_equal"
Cohesion: 0.20
Nodes (9): create_fragment$4(), Day, getStartOfWeek(), instance$1(), instance$4(), isMacOS(), isMetaPressed(), not_equal() (+1 more)
...
Cohesion: 0.11
Nodes (23): MilharScreen(), ModalidadesScreen(), PremiosScreen(), PreviewScreen(), styles, PuleTermica(), PuleTermicaProps, styles (+15 more)

### Community 131 - "SvelteComponent$1"
Cohesion: 0.33
Nodes (3): destroy_component$1(), is_empty$1(), SvelteComponent$1
...
### Community 133 - "i"
Cohesion: 0.03
Nodes (141): a(), a$3(), a$9(), a$c(), addYouTubeThumbnail(), alphaBy(), alphaTo(), applyArabicPresentationForms() (+133 more)
...
### Community 179 - "Exemplo concreto: como usar na Fase 2 (aposta do Bicho)"
Cohesion: 0.40
...
Cohesion: 0.07
Nodes (33): argument(), average(), buildPath(), computeCheckSum(), fail(), fontToSfntTable(), getContours(), getPath() (+25 more)
...
- **Why does `p()` connect `a` to `dataview/main.js`, `i`, `fromObject`, `n`, `e`, `l`, `.slice`, `t`, `templater-obsidian/main.js`, `DataviewApi`, `.onload`, `isValid`, `f`, `constructor`, `format`, `y$1`, `resolve`, `display`, `toString`, `z`, `Fe`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `SegmentChainer$1()` connect `i` to `obsidian-excalidraw-plugin/main.js`, `a`, `f`, `.push`, `ExcalidrawAutomate`, `ExcalidrawSidepanelView`, `.forEach`, `l`?**
